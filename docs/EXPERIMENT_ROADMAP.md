...
### Phase 3C Qwen and similarity-tree fusion

Phase 3C is complete. It freezes the selected Phase 2D Qwen checkpoint and
combines either its five class logits or its 1,024-dimensional final hidden
state with the 173 saved Phase 3B tree features. Qwen received the unchanged
Phase 2D prompt plus original question; no answer, gold evidence, evidence
length, retrieval F1, or Oracle label was an input feature. Qwen parameter
updates were zero.

The compact 178-feature logits-plus-tree model won grouped training-fold
macro-F1 (0.38383459364081357 versus 0.35436172573956737) and was locked as
primary. Validation accuracy/macro-F1/weighted F1/balanced accuracy/top-2 are
0.31926406926406925/0.2306766979333351/0.33398724658349993/
0.2358503567311523/0.5768398268398268. Predictions for
10/20/40/80/160 are 27/88/251/300/258.

The unchanged same-paper top-5 retrieval evaluation covers 924/924 questions
and reaches mean/median joined retrieval F1 0.2872016341991342/0.271346. This
is the strongest downstream retrieval result among Phase 2D, Phase 3B, and
Phase 3C, although Phase 3C classification accuracy is lower than both
components and its macro-F1 gain over Phase 2D is only 0.00073145714050575.

The Phase 2D checkpoint was previously selected on this validation set, and
its representations were not regenerated by nested Qwen fold training.
Phase 3C is therefore a development result, not an unbiased final test
