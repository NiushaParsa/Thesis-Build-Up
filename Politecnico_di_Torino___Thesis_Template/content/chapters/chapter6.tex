...
and nonlinear models use the full representation more effectively
than the tested linear tree model. Original fusion looks promising,
...
The value of adaptation must be demonstrated, not assumed. Here,
the strongest progress came from aligning supervision with retrieval
utility and correcting evaluation weaknesses. Learning from a
decision's consequences, keeping development separate from evaluation,
and retaining a strong fixed baseline provide a sound basis for
the next stage.
